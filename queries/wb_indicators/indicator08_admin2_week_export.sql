...
H_admin1,H_admin1_code,H_admin2,H_admin2_code,
...
from {provider_prefix}_indicator08_week_home_admin2_result
where length(h_admin1)>0 
order by yearr,weekk,first_day_of_week,H_admin1,H_admin1_code,H_admin2,H_admin2_code